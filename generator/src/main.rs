        ...
        writer.scoped(|writer| {
            ...
            writer.scoped(|writer| {
                ...
                writer.scoped(|writer| {
                    ...
                    writer.line("default:");
                    writer.indented(|writer| {
                        writer.line("throw new Exception($\"unknown request command: {command}\");")
                    });
                });
            });
        });
        ...
        writer.scoped(|writer| {
            ...
            writer.scoped(|writer| {
                ...
                writer.scoped(|writer| {
                    ...
                    writer.indented(|writer| {
                        writer
                            .line("throw new Exception($\"unknown response command: {command}\");")
                    });
                });
            });
        });
        ...
        writer.scoped(|writer| {
            ...
            writer.scoped(|writer| {
                ...
                writer.scoped(|writer| {
                    ...
                    writer.line("default:");
                    writer.indented(|writer| {
                        writer.line("throw new Exception($\"unknown event type: {command}\");")
                    });
                });
            });
        });
